    ...
    <div className="space-y-8">
      ...
      {shift && shift.unverified_count > 0 && (
        <div>
          ...
          <div
            className="rounded-2xl overflow-hidden"
            style={{ background: "rgba(15,25,35,0.58)", backdropFilter: "blur(14px)", border: "1px solid rgba(255,149,0,0.28)" }}
          >
      ...
      {shift && shift.voids.length > 0 && (
        <div>
          ...
          <div
            className="rounded-2xl overflow-hidden"
            style={{ background: "rgba(15,25,35,0.58)", backdropFilter: "blur(14px)", border: "1px solid rgba(248,113,113,0.2)" }}
          >
            {shift.voids.map((v, i) => (
              <div
                key={`${v.at}-${i}`}
