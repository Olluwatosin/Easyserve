...
function BarContent() {
  ...
  function loadOrders() {
    api.get("/orders?station=bar").then((r) => {
  ...
  return (
    <div className="min-h-screen bg-bg">
      <header className="bg-bg-surface border-b border-border px-6 py-4">
        <h1 className="font-display text-2xl font-bold text-teal">Bar Display</h1>
        <p className="text-muted text-sm">Drink orders queue</p>
      </header>
                        ...
                        <div className="flex gap-2">
                          {item.status === "pending" && (
                            <button
                              ...
                              className="btn-teal text-xs py-1.5 px-3 flex-1"
                            >
                              Mark Ready
                            </button>
                          )}
