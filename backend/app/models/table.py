...
class Table(Base):
    ...
    extra_attendant_ids: Mapped[str] = mapped_column(String(500), nullable=False, default="")
    # VIP / bottle-service minimum spend (0 = none)
    min_spend: Mapped[float] = mapped_column(Numeric(12, 2), default=0, nullable=False)
